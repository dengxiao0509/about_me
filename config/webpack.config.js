  ...
  return {
    ...
    optimization: {
      ...
      splitChunks: {
        ...
        //  or switch off name generation via optimization.splitChunks.name: false. Elsewise files will invalidate i. e. when more chunks with the same vendors are added.
        // name: false,
        // group all vendors together, for better caching
        // cacheGroups: {
        //   vendor: {
        //     test: /[\\/]node_modules[\\/]/,
        //     name: 'vendors',
